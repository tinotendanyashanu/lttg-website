...
export default function EmployeeChatReply({ sessionId }: { sessionId: string }) {
  ...
  return (
    <div className="bg-white dark:bg-[#27272a] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 space-y-4">
