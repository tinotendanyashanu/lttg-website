...
export const metadata = {
  title: 'Manage Knowledge Base | Admin Panel',
};
      ...
      <div className="bg-white dark:bg-[#27272a] rounded-3xl p-8 border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Knowledge Management Module</h1>
              <p className="text-gray-500 dark:text-gray-400 text-sm mt-0.5">Create, edit, and organize knowledge base articles.</p>
            </div>
          </div>
        </div>
      </div>

      <KnowledgeManagerClient initialArticles={initialArticles} />
    </div>
  );
}
