    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8f9fa] dark:bg-[#0a0a0a] px-4">
      <div className="w-full max-w-[448px] bg-white dark:bg-[#111111] p-8 md:p-12 rounded-2xl border border-[#dadce0] dark:border-[#222] shadow-sm">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-semibold text-[#202124] dark:text-white">Partner Portal</h1>
          <p className="text-sm text-[#5f6368] dark:text-gray-400 mt-2">Access your affiliate dashboard</p>
        </div>

        <form action={dispatch} className="space-y-6">
          <input type="hidden" name="loginSource" value="partner" />
        ...
        <div className="mt-8 pt-8 border-t border-[#f1f3f4] dark:border-[#222] text-center">
          <p className="text-sm text-[#5f6368] dark:text-gray-400">
            Not a partner?{' '}
            <Link href="/partner/signup" className="text-[#1a73e8] hover:underline font-semibold">
              Apply Now
            </Link>
          </p>
        </div>
