    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
        ...
        <form action={dispatch} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Client Phone Number</label>
            <input 
              type="tel" 
              name="clientPhone" 
              required 
            ...
            />
            {state?.errors?.clientPhone && <p className="text-red-500 text-xs mt-1">{state.errors.clientPhone}</p>}
          </div>
