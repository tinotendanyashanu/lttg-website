  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <AdminPageBanner
        icon="history"
        title="Activity Log"
        description={`Read-only audit trail of all admin mutations. Showing latest ${logs.length} entries.`}
      />
      ...
      <div className="bg-white dark:bg-[#27272a] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-soft overflow-hidden">
        {logs.length === 0 ? (
          <div className="py-20 flex flex-col items-center justify-center text-center gap-3">
            <span className="material-icons-outlined text-5xl text-gray-300 dark:text-gray-700">history_toggle_off</span>
